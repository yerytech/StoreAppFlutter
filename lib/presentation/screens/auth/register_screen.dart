          ...
          child: Form(
            ...
            child: Container(
              ...
              child: Column(          
                ...
                SizedBox(height: 20,),
                 InputTextField( validator: FormValidators.validatorEmail,hintText: 'User name', icon: Icons.person_2_outlined, obscureText: false, controller: emailTextController,),
                 SizedBox(height: 20,),
